...
export default function PhotosUploader({ addedPhotos, setAddedPhotos }) {
  ...
  async function addPhotoByLink(ev) {
    ev.preventDefault();
    if (!photoLink) return;
    // rename data property in axios response to filename
  ...
  return (
    <>
      ...
      <div className='mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
        ...
        <label className='h-32 flex gap-1 items-center justify-center cursor-pointer border bg-transparent rounded-2xl text-2xl text-gray-600'>
